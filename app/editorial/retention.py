...
def build_retention_map(target_duration_sec: int) -> dict[str, Any]:
    duration = max(25, min(45, int(target_duration_sec or 35)))
    return {
...
def attach_retention_metadata(script: dict[str, Any], plan_dict: dict[str, Any]) -> dict[str, Any]:
    ...
    enriched.setdefault("retention_map", plan_dict.get("retention_map") or build_retention_map(int(enriched.get("estimated_duration_sec") or 35)))
